...
func (c *orderClient) GetUserLatest(ctx context.Context, in *GetUserLatestRequest, opts ...grpc.CallOption) (*GetUserLatestResponse, error) {
	out := new(GetUserLatestResponse)
	err := c.cc.Invoke(ctx, "/order.Order/GetUserLatest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServer interface {
	...
	GetUserLatest(context.Context, *GetUserLatestRequest) (*GetUserLatestResponse, error)
...
func (UnimplementedOrderServer) GetUserLatest(context.Context, *GetUserLatestRequest) (*GetUserLatestResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserLatest not implemented")
}
...
func _Order_GetUserLatest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserLatestRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServer).GetUserLatest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/order.Order/GetUserLatest",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).GetUserLatest(ctx, req.(*GetUserLatestRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Order_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetUserLatest",
			Handler:    _Order_GetUserLatest_Handler,
		},
	},
