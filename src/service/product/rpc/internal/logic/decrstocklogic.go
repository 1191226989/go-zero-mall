...
func (l *DecrStockLogic) DecrStock(in *proto3.DecrStockRequest) (*proto3.DecrStockResponse, error) {
	...
	// 在 product rpc DecrStock 接口方法中子事务屏障外，人为的制造异常失败。
	// return nil, status.Error(codes.Aborted, dtmcli.ResultFailure)
	return &proto3.DecrStockResponse{}, nil
}
